            ...
            <div class="row">
                <div class="col-lg-7 col-md-6 pl-0">
                    <div class="py-5 mb-xl-4 mb-2 feature-content">
                        ...
                        <div class="py-4">
                                                                    <a class="btn bg-white border-0 without-focus text-color-0-1 text-uppercase font-medium font-16" href="register.html" id="gotoregister" role="button">BECOME A MERCHANT</a>
                                                                </div>
                    </div>
                </div>
                        ...
                        <div class="box mx-auto d-flex justify-content-center mb-4 align-items-center">
                            <svg xmlns:svg="http://www.w3.org/2000/svg" xmlns="http://www.w3.org/2000/svg" version="1.1" x="0px" y="0px" viewBox="0 0 258.75 245.75" xml:space="preserve" width="37" height="43">
                              <g transform="translate(0,1)">
                                <circle cx="129.375" cy="60" r="60" fill="#1dc68c"/>
                                <path fill="#1dc68c" d="m 129.375,136 c -60.061,0 -108.75,48.689 -108.75,108.75 h 217.5 C 238.125,184.689 189.436,136 129.375,136 Z"/>
                              </g>
                            </svg>
                        </div>
                        <div class="w-100">
                        ...
                        <div class="box mx-auto d-flex justify-content-center mb-4 align-items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="-62 0 512 512.001" width="37" height="43">
                                <g fill-rule="evenodd">
                                    ...
                                    <path fill="#1dc68c" d="m41.226562 290.996094h108.003907c8.285156 0 15-6.714844 15-15v-107c0-8.285156-6.714844-15-15-15h-39v25.765625c0 8.285156-6.71875 15-15 15-8.285157 0-15-6.714844-15-15v-25.765625h-39.003907c-8.28125 0-15 6.714844-15 15v107c0 8.285156 6.71875 15 15 15zm0 0"/>
                                </g>
                            </svg>
                        </div>
                        <div class="w-100">
                    ...
                    <div class="row text-center">
                        <div class="box mx-auto d-flex justify-content-center mb-4 align-items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" width="37" height="43" viewBox="0 0 890.5 890.5" xml:space="preserve">
                                <g>
                                    <path fill="#1dc68c" d="M208.1,180.56l355-96.9l-18.8-38c-12.3-24.7-42.3-34.9-67-22.6l-317.8,157.5H208.1z"/>
                                    <path fill="#1dc68c" d="M673.3,86.46c-4.399,0-8.8,0.6-13.2,1.8l-83.399,22.8L322,180.56h289.1h126l-15.6-57.2    C715.5,101.06,695.3,86.46,673.3,86.46z"/>
                        ...
                        <div class="w-100">
                            <div class="card feature-accordion mb-4 border-0">
                                ...
                                <div id="collapseFour" class="collapse" aria-labelledby="feature-four">
                                    <div class="card-body border-top">
                                        At Steadfast Courier we will collect the cash on behalf of you. Our trusted delivery man will deliver your parcel to your customer and collect the money. And then with our various payment methods we will give your money back to you. Also we are giving you the opportunity of sending a non-conditioned parcel to delivery as well.
                                    </div>
                                </div>
                            </div>
                            <div class="card feature-accordion mb-4 border-0">
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" width="60px" height="60px" viewBox="0 0 436.016 436.016" xml:space="preserve">
                                            <defs>
                                                <linearGradient id="grad" x1="0%" y1="0%" x2="0%" y2="100%">
                                                  <stop offset="0%" style="stop-color:#1dc68c;stop-opacity:1" />
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" width="60px" height="60px" viewBox="0 0 459.419 459.419" xml:space="preserve">
                                            <defs>
                                                <linearGradient id="gr-grad1" x1="0%" y1="0%" x2="0%" y2="100%">
                                                  <stop offset="0%" style="stop-color:#1dc68c;stop-opacity:.8" />
                                                  <stop offset="100%" style="stop-color:#1ca777;stop-opacity:1" />
                                                </linearGradient>
                                            </defs>
                                            <g>
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" width="60px" height="60px" viewBox="0 0 612 612" xml:space="preserve">
                                            <defs>
                                                <linearGradient id="gr-grad2" x1="0%" y1="0%" x2="0%" y2="100%">
                                                  <stop offset="0%" style="stop-color:#1dc68c;stop-opacity:.9" />
                                                  <stop offset="100%" style="stop-color:#1ca777;stop-opacity:1" />
                                                </linearGradient>
                                            </defs>
                                            <g>
...
<section class="row" id="pricing">
    <div class="container py-5">
        <div class="pb-5">
            ...
            <div class="options"><div class="row"><div class="col-md-3 col-12"><div class="form-group"><label for="FromId">From</label> <select id="FromId" class="form-control"></select></div></div> <div class="col-md-3 col-12"><div class="form-group"><label for="destinationId">Destination</label> <select id="destinationId" class="form-control"></select></div></div> <div class="col-md-3 col-12"><div class="form-group"><label for="serviceId">Service</label> <select id="serviceId" class="form-control"><option value="1">Regular</option> <option value="2">Same Day</option></select></div></div> <div class="col-md-3 col-12"><div class="form-group"><label for="weightId">Weight (KG)</label> <input type="text" id="weightId" placeholder="Parcel's Weight" class="form-control"></div></div></div> <div class="row"><div class="col"><div class="d-flex justify-content-center"><div class="del-charge"><strong>60 TK</strong></div></div></div></div> <div class="row"><div class="col"><div class="d-flex justify-content-center"><div class="pricing-condition"><p class="text-danger"><!----></p> <p>* 1% Cash Handling &amp; Risk Management Charge will be added. </p> <p>* Price may vary due to parcel size. </p> <p>* All charges are VAT &amp; Tax excluded.  </p> <p>* Unavoidable circumstances may change in time of delivery.</p></div></div></div></div></div>
						...
						<div class="row">
							<div class="col-lg-8 col-md-6">
								<div class="pt-5 pb-4 feature-content">
									...
									<div class="py-4">
										<a class="btn bg-white border-0 without-focus text-color-0-1 text-uppercase font-medium font-11" href="register.html" id="mbl-gotoregister" role="button">BECOME A MERCHANT</a>
									</div>
								</div>
							</div>
						</div>
									...
									<div class="service-item mx-auto d-flex align-items-center justify-content-center">
										<span>
											<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" width="38px" height="38px" viewBox="0 0 436.016 436.016" xml:space="preserve">
												<g>
													<path fill="#1dc68c" d="M309.565,157.136c2.469,5.195,8.668,9.2,14.42,9.314l5.134,0.102c-0.319,1.897-0.493,3.843-0.493,5.83   c0,19.356,15.747,35.104,35.103,35.104c19.356,0,35.104-15.748,35.104-35.104c0-19.356-15.748-35.103-35.104-35.103   c-6.711,0-12.987,1.896-18.325,5.177l-27.958-0.064c-3.579,0-6.595,1.523-8.272,4.178c-1.68,2.657-1.761,6.037-0.222,9.275   L309.565,157.136z"/>
													<path fill="#1dc68c" d="M432.563,254.603l-21.718-30.259c-3.113-4.336-9.055-10.208-17.238-10.208h-59.755c-5.812,0-12.993,2.993-17.084,5.07   l-15.31,7.775c-1.14,0.579-2.665,1.029-4.338,1.318c0.026-0.361,0.055-0.722,0.055-1.09v-65.162c0-8.271-6.729-15-15-15h-56.869   c-8.271,0-15,6.729-15,15v65.162c0,8.271,6.729,15,15,15h25.587c1.889,1.846,4.1,3.329,6.494,4.214l26.75,9.894   c3.166,1.171,7.296,1.816,11.628,1.816c0.001,0,0.001,0,0.001,0c3.917,0,7.669-0.543,10.563-1.53l20.522-6.995v171.537   c0,7.72,6.28,14,14,14h2.744c7.72,0,14-6.28,14-14v-91.026h12.269v91.026c0,7.72,6.28,14,14,14h2.742c7.72,0,14-6.28,14-14V312.617   c6.203-1.081,12.727-5.189,16.091-10.406l16.416-25.455C437.188,270.439,436.945,260.708,432.563,254.603z M400.607,254.837   l5.619,8.064c1.94,2.786,1.921,7.846-0.042,10.616l-5.577,7.872V254.837z"/>
													<path fill="#1dc68c" d="M176.297,0.873H11c-6.065,0-11,4.935-11,11v276.419c0,6.065,4.935,11,11,11h165.297c6.065,0,11-4.935,11-11V11.873   C187.297,5.807,182.362,0.873,176.297,0.873z M57.921,196.965H23.254v-16.756h34.667V196.965z M156.85,136.902H30.447V32.456   H156.85V136.902z"/>
												</g>
											</svg>
										</span>
									</div>
									...
									<div class="service-item mx-auto d-flex align-items-center justify-content-center">
										<span>
											<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" width="38px" height="38px" viewBox="0 0 459.419 459.419" xml:space="preserve">
												<g>
													<polygon fill="#1dc68c" points="83.115,172.911 376.304,172.911 376.304,459.419 458.777,459.419 458.777,106.956     223.178,0 0.642,106.956 0.642,459.419 83.115,459.419   "/>
													<rect fill="#1dc68c" x="171.155" y="403.543" width="52.023" height="44.878"/>
													<rect fill="#1dc68c" x="235.005" y="403.543" width="52.023" height="44.878"/>
													<rect fill="#1dc68c" x="107.313" y="403.543" width="52.023" height="44.878"/>
													<rect fill="#1dc68c" x="171.155" y="341.985" width="52.023" height="44.878"/>
													<rect fill="#1dc68c" x="107.313" y="341.985" width="52.023" height="44.878"/>
													<rect fill="#1dc68c" x="235.005" y="341.985" width="52.023" height="44.878"/>
													<rect fill="#1dc68c" x="171.155" y="280.436" width="52.023" height="44.878"/>
													<rect fill="#1dc68c" x="107.313" y="280.436" width="52.023" height="44.878"/>
													<rect fill="#1dc68c" x="298.847" y="403.543" width="52.023" height="44.878"/>
												</g>
											</svg>
										</span>
									</div>
									...
									<div class="service-item mx-auto d-flex align-items-center justify-content-center">
										<span>
											<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" width="38px" height="38px" viewBox="0 0 612 612" xml:space="preserve">
												<g>
													<path fill="#1dc68c" d="M482.188,83.333L184.622,223.225v89.832l-51.91-23.082v-89.832L430.278,60.252l-99.946-44.439   c-13.383-5.95-35.281-5.95-48.664,0L35.557,125.243C15.95,133.961-0.05,158.649,0,180.107l0.606,256.534   c0.051,21.686,16.408,46.401,36.348,54.926L282.42,596.499c12.945,5.534,34.129,5.534,47.075,0.003l245.55-104.936   c19.939-8.521,36.297-33.234,36.348-54.919L612,180.107c0.051-21.458-15.949-46.146-35.557-54.864L482.188,83.333z    M556.398,288.675l-14.403,6.683l-0.292,101.353c-0.013,4.429-3.925,9.701-8.727,11.773l-21.563,9.309   c-4.727,2.041-8.551,0.149-8.554-4.223l-0.073-100.021l-13.951,6.472c-6.562,3.044-10.669-1.729-7.411-8.601l33.348-70.356   c3.366-7.102,11.806-11.199,15.184-7.347l34.221,39.012C567.593,276.623,563.257,285.494,556.398,288.675z M415.596,451.443   c0.037,4.243-3.55,9.24-8.001,11.162l-19.996,8.632c-4.385,1.893-7.972,0.029-8.022-4.16l-1.171-95.826l-12.938,6.002   c-6.085,2.823-9.968-1.808-7.006-8.344l30.31-66.881c3.057-6.747,10.873-10.541,14.062-6.805l32.301,37.836   c3.226,3.777-0.712,12.202-7.062,15.147l-13.338,6.188L415.596,451.443z M580.201,423.619c-0.015,2.226-2.016,4.865-4.468,5.896   l-228.395,95.95c-2.131,0.896-3.884-0.043-3.915-2.096l-0.175-11.162c-0.032-2.058,1.67-4.463,3.805-5.372l228.802-97.467   c2.455-1.046,4.438-0.086,4.423,2.146L580.201,423.619z"/>
												</g>
											</svg>
										</span>
									</div>
