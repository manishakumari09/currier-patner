...
<head>
    ...
    <style>
        ...
        .super-admin .login-key {
            ...
            font-size: 80px;
            line-height: 100px;
            background: -webkit-linear-gradient(#27EF9F, #30B87B);
        ...
        .super-admin input[type=text], .super-admin input[type=email] {
            background-color: #1A2226;
            border: none;
            border-bottom: 2px solid #30B87B;
            border-top: 0px;
            border-radius: 0px;
            font-weight: bold;
            outline: 0;
        ...
        .super-admin input[type=password] {
            background-color: #1A2226;
            border: none;
            border-bottom: 2px solid #30B87B;
            border-top: 0px;
        ...
        .super-admin .form-control-label {
            font-size: 10px;
            color: #6C6C6C;
            font-weight: bold;
            letter-spacing: 1px;
        ...
        .super-admin .btn-outline-primary {
            border-color: #006A4D;
            color: #006A4D;
            border-radius: 0px;
            font-weight: bold;
        ...
        .super-admin .btn-outline-primary:hover, .super-admin .btn-outline-primary:focus, .super-admin .btn-outline-primary:active {
        ...
        .super-admin .row.foot {
            display: none !important;
        }

        .super-admin .bg-white {
    ...
    <div class="col-md-12 bg-white">
        <nav class="navbar fixed-top shadow-sm navbar-expand-lg py-md-0 py-1 bg-white navbar-light-cs">
            <div class="container">
                ...
                <div>
                    <a href="login.html"
                       class="btn font-13 btn-log text-seagreen border-lightseagreen-1 mr-4 d-lg-none">Login</a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav d-block d-lg-none row">
                        ...
                        <li class="nav-item border-top active">
                            <a class="nav-link font-sm-14 text-dark px-3" href="index.html#mbl-services"
                               id="mbl-gotoservices">Service</a>
                        </li>
                        <li class="nav-item border-top">
                            <a class="nav-link font-sm-14 text-dark px-3" href="coverage-area.html"
                               id="mbl-gotoservicearea">Service area</a>
                        </li>
                        <li class="nav-item border-top">
                            <a class="nav-link font-sm-14 text-dark px-3" href="index.html#mbl-pricing"
                               id="mbl-gotopricing">Pricing</a>
                        </li>
                        <li class="nav-item border-top">
                            ...
                            <form method="post" action="/super-admin-login">
                                ...
                                <div class="col-lg-12 loginbttm">
                                    ...
                                    <div class="col-lg-6 login-btm login-button">
                                        <button type="submit" class="btn btn-outline-primary" name="login_btn"
                                                id="login_btn">LOGIN
                                        </button>
                                    </div>
                                </div>
